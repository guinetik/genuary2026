import{G as H,d as W,P as R,B as I,k as z,p as X,_ as V,$ as A,X as B,e as x,W as K,a3 as Y,a4 as j,a6 as Q,a7 as $,a8 as J,a9 as Z,aa as ee}from"./index-QcdZ2uQe.js";const P=`attribute vec2 aPosition;\r
...
float determineState(float t) {
    ...
    // Stargate: triggers on strong drums (high bass with loud amplitude)
    // Only big bass hits create the tunnel effect
    else if (uBassLevel > 0.65 && uAmplitude > 0.5) {
        state = STATE_STARGATE;
    }
...
`,p={lineWidth:3,glowAmount:15,wave:{noiseScale:.02,maxAmplitude:.3,colorSpeed:1.5},hue:135,hueRange:60,maxTextureWidth:640,maxTextureHeight:480,coverScale:1.06,effects:{bassBlurIntensity:.3,midHueRotationSpeed:2,highEdgeIntensity:.5,amplitudeSaturation:1.5,silenceSolarization:.8,colorTintStrength:.3,motionParticleRate:.1,brightnessReverb:.2},audioEffects:{flanger:!0,djFilter:!1,distortion:!1,tremolo:!0,delay:!0,highShelf:!0,eq:!0}};class te extends H{constructor(e){super(e),this.backgroundColor="#000"}init(){super.init(),W.init(this),R.init(this.ctx),this.time=0,this.idlePhase=0,this.colorPhase=0,this.webgl=null,this.webglAvailable=!1,this.videoTexture=null,this.videoStream=null,this.videoElement=null,this.audioContext=null,this.analyser=null,this.audioSource=null,this.audioBuffer=null,this.isPlaying=!1,this.videoCanvas=null,this.videoCtx=null,this.currentFrame=null,this.textureCanvas=null,this.textureCtx=null,this.textureWidth=0,this.textureHeight=0,this.frequencyData=null,this.bassLevel=0,this.midLevel=0,this.highLevel=0,this.amplitude=0,this.dominantColor={r:0,g:255,b:0},this.motionAmount=0,this.brightness=.5,this.prevFrame=null,this.distortionAmount=0,this.videoFrequencyData=null,this.videoBrightnessData=null,this.videoColorData=null,this.videoMotionData=null,this.spectrumBars=64,this.smoothedAudioFreq=new Float32Array(64),this.smoothedVideoFreq=new Float32Array(64),this.mouseX=.5,this.mouseY=.5,this.mouseDown=!1,this.rippleTime=0,this.videoSource="camera",this.audioSource="mic",this.settingsScene=null,this.selectedVideoFile=null,this.selectedAudioFile=null,this.videoFileInput=null,this.audioFileInput=null,this.startButton=new I(this,{text:"start synesthesia",width:200,height:50,font:'16px "Fira Code", monospace',onClick:()=>this.fsm.setState("settings")}),this.startButton.x=this.width/2,this.startButton.y=this.height/2+100,this.pipeline.add(this.startButton),this.backButton=new I(this,{x:80,y:30,width:100,height:30,text:"← Back",onClick:()=>this.fsm.setState("intro")}),this.pipeline.add(this.backButton),this.initStateMachine(),this.handleKeyDown=e=>{(e.key==="r"||e.key==="R")&&this.restart()},window.addEventListener("keydown",this.handleKeyDown)}initStateMachine(){this.fsm=new z({initial:"intro",context:this,states:{intro:{enter:()=>{this.startButton.visible=!0,this.startButton.interactive=!0,this.backButton.visible=!1,this.backButton.interactive=!1,this.settingsScene&&(this.pipeline.remove(this.settingsScene),this.settingsScene=null)}},settings:{enter:()=>{this.startButton.visible=!1,this.startButton.interactive=!1,this.backButton.visible=!0,this.backButton.interactive=!0,this.createSettingsUI()},exit:()=>{this.settingsScene&&(this.pipeline.remove(this.settingsScene),this.settingsScene=null)}},synesthesia:{enter:()=>{this.startButton.visible=!1,this.startButton.interactive=!1,this.backButton.visible=!0,this.backButton.interactive=!0,this.startSynesthesia()},exit:()=>{this.cleanupSynesthesia()}}}})}restart(){this.fsm&&this.fsm.is("synesthesia")&&this.cleanupSynesthesia(),this.fsm&&this.fsm.setState("intro")}createSettingsUI(){this.settingsScene=new X(this,{width:this.width,height:this.height,anchor:"center"}),this.settingsScene.x=this.width/2,this.settingsScene.y=this.height/2;const e=new V(this,{spacing:30,padding:20});this.settingsScene.add(e);const t=new A(this,"--- VIDEO ---",{font:'18px "Fira Code", monospace',color:"#0f0",align:"center",baseline:"middle"});e.add(t);const a=new V(this,{spacing:8,padding:0});e.add(a);const r=new B(this,{spacing:20,padding:10});a.add(r);const l=new x(this,{text:"Camera",width:120,height:40,font:'14px "Fira Code", monospace',startToggled:this.videoSource==="camera",onToggle:o=>{o&&(this.videoSource="camera",this.videoFileBtn.toggle(!1),this.videoFileBtn.text="File",this.selectedVideoFile=null,this.videoFileNameLabel&&(this.videoFileNameLabel.text=""))}});r.add(l),this.videoFileBtn=new x(this,{text:"File",width:120,height:40,font:'14px "Fira Code", monospace',startToggled:this.videoSource==="file",onToggle:o=>{o&&(this.videoSource="file",l.toggle(!1),this.selectVideoFile())}}),r.add(this.videoFileBtn),this.videoFileNameLabel=new A(this,"",{font:'11px "Fira Code", monospace',color:"#0f0",align:"center",baseline:"top"}),a.add(this.videoFileNameLabel);const d=new A(this,"--- AUDIO ---",{font:'18px "Fira Code", monospace',color:"#0f0",align:"center",baseline:"middle"});e.add(d);const c=new V(this,{spacing:8,padding:0});e.add(c);const i=new B(this,{spacing:20,padding:10});c.add(i);const n=new x(this,{text:"MIC",width:120,height:40,font:'14px "Fira Code", monospace',startToggled:this.audioSource==="mic",onToggle:o=>{o&&(this.audioSource="mic",this.audioFileBtn.toggle(!1),this.audioFileBtn.text="FILE",this.selectedAudioFile=null,this.audioFileNameLabel&&(this.audioFileNameLabel.text=""))}});i.add(n),this.audioFileBtn=new x(this,{text:"FILE",width:120,height:40,font:'14px "Fira Code", monospace',startToggled:this.audioSource==="file",onToggle:o=>{o&&(this.audioSource="file",n.toggle(!1),this.selectAudioFile())}}),i.add(this.audioFileBtn),this.audioFileNameLabel=new A(this,"",{font:'11px "Fira Code", monospace',color:"#0f0",align:"center",baseline:"top"}),c.add(this.audioFileNameLabel);const s=new I(this,{text:"start",width:200,height:50,font:'16px "Fira Code", monospace',onClick:()=>this.fsm.setState("synesthesia")});e.add(s),this.pipeline.add(this.settingsScene),this.createFileInputs(),this.selectedVideoFile&&(this.updateVideoFileName(this.selectedVideoFile.name),this.videoFileBtn.text="File ✓"),this.selectedAudioFile&&(this.updateAudioFileName(this.selectedAudioFile.name),this.audioFileBtn.text="FILE ✓")}createFileInputs(){this.videoFileInput=document.createElement("input"),this.videoFileInput.type="file",this.videoFileInput.accept="video/*",this.videoFileInput.style.display="none",this.videoFileInput.addEventListener("change",e=>{const t=e.target.files[0];t&&(this.selectedVideoFile=t,this.updateVideoFileName(t.name),this.videoFileBtn.text="File ✓")}),document.body.appendChild(this.videoFileInput),this.audioFileInput=document.createElement("input"),this.audioFileInput.type="file",this.audioFileInput.accept="audio/*",this.audioFileInput.style.display="none",this.audioFileInput.addEventListener("change",e=>{const t=e.target.files[0];t&&(this.selectedAudioFile=t,this.updateAudioFileName(t.name),this.audioFileBtn.text="FILE ✓")}),document.body.appendChild(this.audioFileInput)}updateVideoFileName(e){if(!this.videoFileNameLabel)return;const t=25;let a=e;e.length>t&&(a=e.substring(0,t-1)+"…"),this.videoFileNameLabel.text=a,this.videoFileNameLabel.color="#0f0"}updateAudioFileName(e){if(!this.audioFileNameLabel)return;const t=25;let a=e;e.length>t&&(a=e.substring(0,t-1)+"…"),this.audioFileNameLabel.text=a,this.audioFileNameLabel.color="#0f0"}selectVideoFile(){this.videoFileInput&&this.videoFileInput.click()}selectAudioFile(){this.audioFileInput&&this.audioFileInput.click()}async startSynesthesia(){try{if(this.videoSource==="file"&&!this.selectedVideoFile){alert("Please select a video file first."),this.videoSource="camera",this.videoFileBtn&&this.videoFileBtn.toggle(!1);return}if(this.audioSource==="file"&&!this.selectedAudioFile){alert("Please select an audio file first."),this.audioSource="mic",this.audioFileBtn&&this.audioFileBtn.toggle(!1);return}if(this.videoElement=document.createElement("video"),this.videoElement.autoplay=!0,this.videoElement.playsInline=!0,this.videoElement.muted=!0,this.videoElement.width=this.width,this.videoElement.height=this.height,this.videoElement.loop=!0,this.videoSource==="camera"){const t=await navigator.mediaDevices.getUserMedia({video:{width:{ideal:this.width},height:{ideal:this.height}}});this.videoStream=t.getVideoTracks()[0],this.videoElement.srcObject=t}else{const t=URL.createObjectURL(this.selectedVideoFile);this.videoElement.src=t,this.videoElement.addEventListener("loadedmetadata",()=>{this.videoElement.play().then(()=>{this.processVideo()}).catch(a=>{console.error("Video play failed:",a),this.processVideo()})})}if(this.videoCanvas=document.createElement("canvas"),this.videoCanvas.width=this.width,this.videoCanvas.height=this.height,this.videoCtx=this.videoCanvas.getContext("2d",{willReadFrequently:!0}),this.textureCanvas=document.createElement("canvas"),this.textureCtx=this.textureCanvas.getContext("2d",{willReadFrequently:!1}),this.webgl=new K(this.width,this.height),!this.webgl.isAvailable())console.warn("WebGL not available, falling back to canvas 2D"),this.webglAvailable=!1;else{this.webglAvailable=!0,this.webgl.useProgram("synesthesia",P,N);const t=this.webgl.gl;this.videoTexture=t.createTexture(),t.bindTexture(t.TEXTURE_2D,this.videoTexture),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_S,t.CLAMP_TO_EDGE),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_T,t.CLAMP_TO_EDGE),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_MIN_FILTER,t.LINEAR),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_MAG_FILTER,t.LINEAR)}this.audioContext=new(window.AudioContext||window.webkitAudioContext),this.analyser=this.audioContext.createAnalyser(),this.analyser.fftSize=2048,this.analyser.smoothingTimeConstant=.8,this.frequencyData=new Uint8Array(this.analyser.frequencyBinCount),this.videoFrequencyData=new Float32Array(this.spectrumBars),this.videoBrightnessData=new Float32Array(this.spectrumBars),this.videoColorData=new Float32Array(this.spectrumBars),this.videoMotionData=new Float32Array(this.spectrumBars),this.smoothedAudioFreq=new Float32Array(this.spectrumBars),this.smoothedVideoFreq=new Float32Array(this.spectrumBars),this.setupMouseHandlers();const e=p.audioEffects;if(e.distortion,e.delay&&(this.delay=new Y(this.audioContext,{delayTime:.15,maxDelay:.5,feedback:.2,wet:.15,dry:.85})),e.flanger&&(this.flanger=new j(this.audioContext,{baseDelay:.005,maxDelay:.02,lfoFrequency:.5,lfoDepth:.002,feedback:.5,wet:0,dry:1})),e.djFilter,e.tremolo&&(this.tremolo=new Q(this.audioContext,{rate:4,depth:0,lfoType:"sine"})),e.eq){const t=Math.min(this.spectrumBars,16);this.eqBank=new $(this.audioContext,{numBands:t,minFreq:40,maxFreq:12e3,Q:4}),this.audioFilters=this.eqBank.getFilters()}if(e.highShelf&&(this.highShelf=new J(this.audioContext,{frequency:4e3,gain:3})),this.limiter=new Z(this.audioContext,{threshold:-3,knee:0,ratio:20,attack:.001,release:.1}),this.compressor=this.limiter.getNode(),this.masterGain=new ee(this.audioContext,1),this.audioSource==="mic"){const t=await navigator.mediaDevices.getUserMedia({audio:!0}),a=this.audioContext.createMediaStreamSource(t);this.connectAudioWithFilters(a)}else await this.loadAudioFile(this.selectedAudioFile);this.videoSource==="camera"&&this.processVideo()}catch(e){console.error("Error starting synesthesia:",e),this.videoSource==="camera"?alert("Could not access webcam. Please allow permissions."):this.audioSource==="mic"?alert("Could not access microphone. Please allow permissions."):alert("Error starting synesthesia: "+e.message)}}cleanupSynesthesia(){if(this.videoStream&&(this.videoStream.getTracks().forEach(e=>e.stop()),this.videoStream=null),this.audioSource){try{this.audioSource.stop&&this.audioSource.stop(),this.audioSource.disconnect&&this.audioSource.disconnect()}catch{}this.audioSource=null}if(this.distortion){try{this.distortion.disconnect()}catch{}this.distortion=null}if(this.delay){try{this.delay.disconnect()}catch{}this.delay=null}if(this.flanger){try{this.flanger.disconnect()}catch{}this.flanger=null}if(this.djFilter){try{this.djFilter.disconnect()}catch{}this.djFilter=null}if(this.tremolo){try{this.tremolo.disconnect()}catch{}this.tremolo=null}if(this.eqBank){try{this.eqBank.disconnect()}catch{}this.eqBank=null}if(this.highShelf){try{this.highShelf.disconnect()}catch{}this.highShelf=null}if(this.limiter){try{this.limiter.disconnect()}catch{}this.limiter=null}if(this.masterGain){try{this.masterGain.disconnect()}catch{}this.masterGain=null}this.compressor=null,this.audioFilters=[],this.audioContext&&this.audioContext.state!=="closed"&&(this.audioContext.close().catch(()=>{}),this.audioContext=null),this.videoElement&&(this.videoElement.pause(),this.videoElement.src&&this.videoElement.src.startsWith("blob:")&&URL.revokeObjectURL(this.videoElement.src),this.videoElement.srcObject=null,this.videoElement.src="",this.videoElement=null),this.currentFrame=null,this.videoCanvas=null,this.videoCtx=null,this.textureCanvas=null,this.textureCtx=null,this.textureWidth=0,this.textureHeight=0,this.rawAnalysisCanvas=null,this.rawAnalysisCtx=null,this.frequencyData=null,this.webglAvailable&&this.webgl&&this.videoTexture&&(this.webgl.gl.deleteTexture(this.videoTexture),this.videoTexture=null)}createAudioFileInput(){const e=document.createElement("input");e.type="file",e.accept="audio/*",e.style.display="none",document.body.appendChild(e),e.addEventListener("change",async t=>{t.target.files.length>0&&(await this.loadAudioFile(t.target.files[0]),e.remove())}),e.click()}async loadAudioFile(e){try{const t=await e.arrayBuffer();this.audioBuffer=await this.audioContext.decodeAudioData(t),this.audioSource=this.audioContext.createBufferSource(),this.audioSource.buffer=this.audioBuffer,this.connectAudioWithFilters(this.audioSource),this.audioSource.onended=()=>{this.isPlaying=!1,this.startAudioPlayback()},this.startAudioPlayback()}catch(t){console.error("Error loading audio file:",t),alert("Could not load audio file.")}}startAudioPlayback(){!this.audioBuffer||!this.audioContext||(this.audioSource=this.audioContext.createBufferSource(),this.audioSource.buffer=this.audioBuffer,this.connectAudioWithFilters(this.audioSource),this.audioSource.onended=()=>{this.isPlaying=!1,this.startAudioPlayback()},this.audioSource.start(0),this.isPlaying=!0)}processVideo(){if(!this.fsm.is("synesthesia")||!this.videoElement)return;const e=this.videoElement.videoWidth||this.width,t=this.videoElement.videoHeight||this.height,a=e/t;let r=p.maxTextureWidth,l=p.maxTextureHeight;r/a>l?r=Math.floor(l*a):l=Math.floor(r/a),(this.textureCanvas.width!==r||this.textureCanvas.height!==l)&&(this.textureCanvas.width=r,this.textureCanvas.height=l,this.textureWidth=r,this.textureHeight=l,console.log(`[Day30] Texture undersampled: ${e}x${t} → ${r}x${l}`)),(this.videoCanvas.width!==this.width||this.videoCanvas.height!==this.height)&&(this.videoCanvas.width=this.width,this.videoCanvas.height=this.height),this.textureCtx.drawImage(this.videoElement,0,0,r,l);const d=this.width/this.height;let c,i,n,s;d>a?(c=this.width,i=this.width/a,n=0,s=(this.height-i)/2):(i=this.height,c=this.height*a,n=(this.width-c)/2,s=0),this.videoCtx.fillStyle="#000",this.videoCtx.fillRect(0,0,this.width,this.height),this.videoCtx.drawImage(this.videoElement,n,s,c,i),this.rawAnalysisCanvas||(this.rawAnalysisCanvas=document.createElement("canvas"),this.rawAnalysisCtx=this.rawAnalysisCanvas.getContext("2d",{willReadFrequently:!0})),(this.rawAnalysisCanvas.width!==r||this.rawAnalysisCanvas.height!==l)&&(this.rawAnalysisCanvas.width=r,this.rawAnalysisCanvas.height=l),this.rawAnalysisCtx.drawImage(this.textureCanvas,0,0,r,l);const o=this.rawAnalysisCtx.getImageData(0,0,r,l);if(this.analyzeVisual(o),this.prevFrame=new Uint8Array(o.data),this.webglAvailable&&this.videoTexture&&this.webgl){const u=this.webgl.gl;u.isTexture(this.videoTexture)&&(u.bindTexture(u.TEXTURE_2D,this.videoTexture),u.texImage2D(u.TEXTURE_2D,0,u.RGBA,u.RGBA,u.UNSIGNED_BYTE,this.textureCanvas))}requestAnimationFrame(()=>this.processVideo())}analyzeVisual(e){const t=e.data,a=e.width,r=e.height;let l=0,d=0,c=0,i=0,n=0;const s=t.length/4;this.videoFrequencyData||(this.videoFrequencyData=new Float32Array(this.spectrumBars),this.videoBrightnessData=new Float32Array(this.spectrumBars),this.videoColorData=new Float32Array(this.spectrumBars),this.videoMotionData=new Float32Array(this.spectrumBars));for(let h=0;h<this.videoFrequencyData.length;h++)this.videoFrequencyData[h]=0,this.videoBrightnessData[h]=0,this.videoColorData[h]=0,this.videoMotionData[h]=0;const o=this.videoFrequencyData.length,u=Math.floor(a/o);for(let h=0;h<o;h++){let v=0,b=0,w=0,m=0;const C=h*u,D=Math.min((h+1)*u,a);for(let g=0;g<r;g+=2)for(let y=C;y<D;y+=2){const f=(g*a+y)*4;if(f+2<t.length){const T=t[f],S=t[f+1],E=t[f+2],L=(T*.299+S*.587+E*.114)/255;v+=L;const F=Math.max(T,S,E),_=Math.min(T,S,E),M=F>0?(F-_)/F:0;if(b+=M,this.prevFrame&&f<this.prevFrame.length){const O=this.prevFrame[f],k=this.prevFrame[f+1],G=this.prevFrame[f+2],q=Math.abs(T-O)+Math.abs(S-k)+Math.abs(E-G);w+=q/765}m++}}if(m>0){const g=v/m,y=b/m,f=m>0?w/m:0;this.videoBrightnessData[h]=g,this.videoColorData[h]=y,this.videoMotionData[h]=f,this.videoFrequencyData[h]=g*.5+y*.3+f*.2}}for(let h=0;h<t.length;h+=4){const v=t[h],b=t[h+1],w=t[h+2];l+=v,d+=b,c+=w;const m=(v*.299+b*.587+w*.114)/255;if(i+=m,this.prevFrame){const C=this.prevFrame[h],D=this.prevFrame[h+1],g=this.prevFrame[h+2],y=Math.abs(v-C)+Math.abs(b-D)+Math.abs(w-g);n+=y/765}}this.dominantColor={r:Math.floor(l/s),g:Math.floor(d/s),b:Math.floor(c/s)},this.brightness=i/s,this.motionAmount=n/s}analyzeAudio(){if(!this.analyser||!this.frequencyData){this.bassLevel=0,this.midLevel=0,this.highLevel=0,this.amplitude=0;return}this.analyser.getByteFrequencyData(this.frequencyData),this.updateAudioFilters();const e=.85;if(this.smoothedAudioFreq&&this.smoothedVideoFreq)for(let n=0;n<this.spectrumBars;n++){const s=Math.floor(n/this.spectrumBars*this.frequencyData.length),o=this.frequencyData[s]/255;this.smoothedAudioFreq[n]=this.smoothedAudioFreq[n]*e+o*(1-e);const u=this.videoFrequencyData[n]||0;this.smoothedVideoFreq[n]=this.smoothedVideoFreq[n]*e+u*(1-e)}const t=Math.floor(this.frequencyData.length*.1),a=Math.floor(this.frequencyData.length*.1),r=Math.floor(this.frequencyData.length*.5),l=Math.floor(this.frequencyData.length*.5);let d=0,c=0,i=0;for(let n=0;n<t;n++)d+=this.frequencyData[n];for(let n=a;n<r;n++)c+=this.frequencyData[n];for(let n=l;n<this.frequencyData.length;n++)i+=this.frequencyData[n];this.bassLevel=d/(t*255),this.midLevel=c/((r-a)*255),this.highLevel=i/((this.frequencyData.length-l)*255),this.amplitude=this.bassLevel*.5+this.midLevel*.3+this.highLevel*.2}updateDistortionCurve(e){this.distortion&&this.distortion.setAmount(e)}connectAudioWithFilters(e){if(!this.audioContext)return;let t=e;if(this.eqBank){this.eqBank.connect(t);const a=this.eqBank.getFilters();t=a[a.length-1]}this.flanger&&(this.flanger.connect(t),t=this.flanger.output),this.djFilter&&(this.djFilter.connect(t),t=this.djFilter.getNode()),this.distortion&&(this.distortion.connect(t),t=this.distortion.getNode()),this.tremolo&&(this.tremolo.connect(t),t=this.tremolo.getNode()),this.highShelf&&(this.highShelf.connect(t),t=this.highShelf.getNode()),this.delay&&(this.delay.connect(t),t=this.delay.getOutput()),this.limiter&&(this.limiter.connect(t),t=this.limiter.getNode()),this.masterGain&&(this.masterGain.connect(t),t=this.masterGain.getNode()),this.analyser?(t.connect(this.analyser),this.analyser.connect(this.audioContext.destination)):t.connect(this.audioContext.destination)}updateAudioFilters(){var c;if(!this.videoFrequencyData||!this.videoBrightnessData||!this.videoColorData||!this.videoMotionData)return;const e=((c=this.audioFilters)==null?void 0:c.length)||0,t=this.videoFrequencyData.length;let a=0,r=0,l=0;for(let i=0;i<t;i++)a+=this.videoBrightnessData[i]||0,r+=this.videoColorData[i]||0,l+=this.videoMotionData[i]||0;a/=t,r/=t,l/=t;const d=Math.min(1,l*2);if(this.flanger){const n=r*d*.25,o=this.flanger.wetGain.gain.value*.95+n*.05;this.flanger.setMix(o,1-o),this.flanger.setLFOFrequency(.3+d*.5)}if(this.djFilter){const n=2e4*(1-d*(1-a)*.3*.8),s=1+d*2,o=this.djFilter.filter.frequency.value,u=this.djFilter.filter.Q.value;this.djFilter.setFrequency(o*.95+n*.05),this.djFilter.setQ(u*.95+s*.05)}if(this.distortion){const i=d*.25;this.distortionAmount=this.distortionAmount*.95+i*.05,this.distortion.setAmount(this.distortionAmount)}if(this.delay){const i=d*.15,n=this.delay.wetGain.gain.value,s=this.delay.dryGain.gain.value,o=n*.95+i*.05;this.delay.setMix(o,s)}if(this.tremolo){const i=d*.15,s=this.tremolo.depthGain.gain.value*.95+i*.05;this.tremolo.setDepth(s)}if(this.highShelf){const i=d*4,s=this.highShelf.filter.gain.value*.95+i*.05;this.highShelf.setGain(s)}if(e>0&&this.audioFilters){const i=Math.floor(e*.3),n=Math.floor(e*.7);for(let s=0;s<e;s++){let o=0;s<i?o=d*3:s<n?o=d*2:o=d*4;const u=this.audioFilters[s];u.gain.value=u.gain.value*.95+o*.05,u.Q.value=1}}}mix(e,t,a){return e+(t-e)*a}setupMouseHandlers(){this.canvas.addEventListener("mousemove",e=>{const t=this.canvas.getBoundingClientRect();this.mouseX=(e.clientX-t.left)/t.width,this.mouseY=(e.clientY-t.top)/t.height}),this.canvas.addEventListener("mousedown",e=>{this.mouseDown=!0,this.rippleTime=0;const t=this.canvas.getBoundingClientRect();this.mouseX=(e.clientX-t.left)/t.width,this.mouseY=(e.clientY-t.top)/t.height}),this.canvas.addEventListener("mouseup",()=>{this.mouseDown=!1}),this.canvas.addEventListener("mouseleave",()=>{this.mouseDown=!1})}update(e){super.update(e),this.fsm&&this.fsm.update(e),this.time+=e,this.idlePhase+=e*.5,this.fsm&&this.fsm.is("synesthesia")&&(this.rippleTime+=e),this.colorPhase+=e*p.wave.colorSpeed,this.fsm&&this.fsm.is("synesthesia")&&this.analyzeAudio(),this.startButton&&this.fsm&&this.fsm.is("intro")&&(this.startButton.x=this.width/2,this.startButton.y=this.height/2+100),this.settingsScene&&this.fsm&&this.fsm.is("settings"),this.webglAvailable&&this.webgl&&(this.webgl.width!==this.width||this.webgl.height!==this.height)&&this.webgl.resize(this.width,this.height)}render(){var r,l,d,c;const e=this.ctx,t=this.width,a=this.height;if(R.setContext(e),this.fsm&&this.fsm.is("synesthesia")){if(this.webglAvailable&&this.webgl&&this.videoTexture){const i=this.webgl.gl;if(i.isTexture(this.videoTexture)){this.webgl.useProgram("synesthesia",P,N),i.activeTexture(i.TEXTURE0),i.bindTexture(i.TEXTURE_2D,this.videoTexture);const n=(r=this.webgl.programs)==null?void 0:r.get("synesthesia");if(n){const o=i.getUniformLocation(n,"uVideoTexture");o&&i.uniform1i(o,0)}const s={uResolution:[t,a],uTime:this.time,uBassLevel:this.bassLevel||0,uMidLevel:this.midLevel||0,uHighLevel:this.highLevel||0,uAmplitude:this.amplitude||0,uSilence:(this.amplitude||0)<.1?1:0,uDominantColor:[((l=this.dominantColor)==null?void 0:l.r)||0,((d=this.dominantColor)==null?void 0:d.g)||0,((c=this.dominantColor)==null?void 0:c.b)||0],uMotionAmount:this.motionAmount||0,uBrightness:this.brightness||.5,uSpectrumBars:0,uMouse:[this.mouseX||0,this.mouseY||0],uMouseDown:this.mouseDown?1:0,uRippleTime:this.rippleTime||0};this.webgl.setUniforms(s),this.webgl.clear(0,0,0,1),this.webgl.render(),e.drawImage(this.webgl.getCanvas(),0,0,t,a)}}else this.currentFrame&&e.drawImage(this.currentFrame,0,0,t,a);this.backButton&&this.backButton.visible&&(e.save(),e.globalAlpha=1,e.shadowBlur=0,e.shadowColor="transparent",this.backButton.render(),e.restore())}else{const i=a/2;e.fillStyle="rgba(0, 0, 0, 0.15)",e.fillRect(0,0,t,a);const n=this.generateWavePoints(t,a,i);n.length>=2&&this.drawWave(e,n,t,a,i),this.fsm&&this.fsm.is("intro")&&this.startButton&&(e.save(),e.globalAlpha=1,e.shadowBlur=0,e.shadowColor="transparent",this.startButton.render(),e.restore()),this.pipeline.render(e),this.fsm&&this.fsm.is("settings")&&this.backButton&&this.backButton.visible&&(e.save(),e.globalAlpha=1,e.shadowBlur=0,e.shadowColor="transparent",this.backButton.render(),e.restore())}}generateWavePoints(e,t,a){const r=[];for(let c=0;c<200;c++){const i=c/200*e,n=this.idlePhase,s=Math.sin(c*.05+n*.8)*.5*.3+Math.sin(c*.12-n*1.2)*.5*.2+Math.sin(c*.03+n*.3)*.05+(Math.random()-.5)*.5*.1,o=a+s*t*.4;r.push({x:i,y:o,v:s})}return r}drawWave(e,t,a,r,l){e.save();const d=p.hue+Math.sin(this.colorPhase)*p.hueRange,c=70,i=50;e.shadowColor=`hsl(${d}, ${c}%, ${i}%)`,e.shadowBlur=p.glowAmount,e.lineWidth=p.lineWidth,e.lineCap="round",e.lineJoin="round",e.strokeStyle=`hsl(${d}, ${c}%, ${i}%)`,e.beginPath(),e.moveTo(t[0].x,t[0].y);for(let s=1;s<t.length-1;s++){const o=t[s],u=t[s+1],h=o.x+(u.x-o.x)*.5,v=o.y+(u.y-o.y)*.5;e.quadraticCurveTo(o.x,o.y,h,v)}const n=t[t.length-1];e.lineTo(n.x,n.y),e.stroke(),e.globalAlpha=.6,e.lineWidth=p.lineWidth*.5,e.strokeStyle=`hsl(${d}, 100%, 90%)`,e.stroke(),e.restore()}stop(){if(this.handleKeyDown&&window.removeEventListener("keydown",this.handleKeyDown),this.cleanupSynesthesia(),this.videoElement&&(this.videoElement.pause(),this.videoElement.srcObject=null,this.videoElement.src=""),this.videoStream&&(this.videoStream.getTracks().forEach(e=>e.stop()),this.videoStream=null),this.audioSource){try{this.audioSource.stop&&this.audioSource.stop(),this.audioSource.disconnect&&this.audioSource.disconnect()}catch{}this.audioSource=null}this.audioContext&&this.audioContext.state!=="closed"&&(this.audioContext.close().catch(()=>{}),this.audioContext=null),this.webglAvailable&&this.webgl&&(this.videoTexture&&(this.webgl.gl.deleteTexture(this.videoTexture),this.videoTexture=null),this.webgl.destroy(),this.webgl=null),this.videoFileInput&&this.videoFileInput.parentNode&&(this.videoFileInput.parentNode.removeChild(this.videoFileInput),this.videoFileInput=null),this.audioFileInput&&this.audioFileInput.parentNode&&(this.audioFileInput.parentNode.removeChild(this.audioFileInput),this.audioFileInput=null),super.stop()}}function oe(U){const e=new te(U);return e.start(),{stop:()=>e.stop(),game:e,handlesResize:!0}}export{oe as default};
