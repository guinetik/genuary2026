import{G as g,W as u}from"./gcanvas.es-Dc5p5ZkO.js";const n=`
...
`,a={tilings:[{n1:3,n2:7,name:"Triangles"},{n1:7,n2:3,name:"Heptagons"},{n1:5,n2:4,name:"Pentagons"},{n1:4,n2:5,name:"Squares"},{n1:6,n2:4,name:"Hexagons"},{n1:8,n2:3,name:"Octagons"}],currentTiling:0,rotationSpeed:.1,hueSpeed:.02};class d extends g{constructor(t){super(t),this.backgroundColor="#000"}init(){if(super.init(),this.time=0,this.hue=.38,this.zoom=10,this.targetZoom=10,this.offsetX=0,this.offsetY=0,this.targetOffsetX=0,this.targetOffsetY=0,this.rotation=0,this.isDragging=!1,this.lastMouseX=0,this.lastMouseY=0,this._glRenderer=new u(this.width,this.height),!this._glRenderer.isAvailable()){console.warn("WebGL not available, falling back to basic render"),this._webglAvailable=!1;return}this._webglAvailable=!0,this._glRenderer.useProgram("poincare",n,l),this._hasDragged=!1,this._lastTilingChange=0,this._mouseDownTime=0,this.canvas.addEventListener("mousedown",t=>{this.isDragging=!0,this._hasDragged=!1,this._mouseDownTime=Date.now();const e=this.canvas.getBoundingClientRect();this.lastMouseX=t.clientX-e.left,this.lastMouseY=t.clientY-e.top}),this.canvas.addEventListener("mousemove",t=>{if(!this.isDragging)return;const e=this.canvas.getBoundingClientRect(),i=t.clientX-e.left,o=t.clientY-e.top,s=Math.abs(i-this.lastMouseX),c=Math.abs(o-this.lastMouseY);(s>5||c>5)&&(this._hasDragged=!0);const h=(i-this.lastMouseX)/Math.min(this.width,this.height)*this.zoom*2,f=(o-this.lastMouseY)/Math.min(this.width,this.height)*this.zoom*2;this.targetOffsetX-=h,this.targetOffsetY+=f,this.lastMouseX=i,this.lastMouseY=o}),this.canvas.addEventListener("mouseup",()=>{const t=Date.now(),e=t-this._mouseDownTime,i=t-this._lastTilingChange;!this._hasDragged&&e<300&&i>500&&(a.currentTiling=(a.currentTiling+1)%a.tilings.length,this._lastTilingChange=t),this.isDragging=!1}),this.canvas.addEventListener("mouseleave",()=>{this.isDragging=!1}),this.canvas.addEventListener("wheel",t=>{t.preventDefault();const e=t.deltaY>0?1.1:.9;this.targetZoom*=e,this.targetZoom=Math.min(50,this.targetZoom)},{passive:!1})}update(t){super.update(t),this.time+=t,this.hue=(this.hue+a.hueSpeed*t)%1,this.rotation+=a.rotationSpeed*t,this.isDragging||(this.targetOffsetX*=.98,this.targetOffsetY*=.98),this.zoom+=(this.targetZoom-this.zoom)*.1,this.offsetX+=(this.targetOffsetX-this.offsetX)*.1,this.offsetY+=(this.targetOffsetY-this.offsetY)*.1,this._webglAvailable&&(this._glRenderer.width!==this.width||this._glRenderer.height!==this.height)&&(this._glRenderer.resize(this.width,this.height),this._glRenderer.useProgram("poincare",n,l))}render(){const t=this.ctx;if(this._webglAvailable){const e=a.tilings[a.currentTiling],i=this._glRenderer,o=i.gl;i.useProgram("poincare",n,l),i.setUniforms({uTime:this.time,uResolution:[this.width,this.height],uZoom:this.zoom,uOffset:[this.offsetX,this.offsetY],uRotation:this.rotation,uHue:this.hue});const s=i.programs.get("poincare");o.uniform1i(o.getUniformLocation(s,"uN1"),e.n1),o.uniform1i(o.getUniformLocation(s,"uN2"),e.n2),i.clear(0,0,0,1),i.render(),i.compositeOnto(t,0,0),t.font='14px "Fira Code", monospace',t.fillStyle=`hsl(${this.hue*360}, 70%, 60%)`,t.textAlign="left",t.fillText(`{${e.n1}, ${e.n2}} ${e.name.toUpperCase()}`,15,25),t.fillStyle="rgba(255,255,255,0.5)",t.fillText("CLICK: CHANGE · DRAG: PAN · SCROLL: ZOOM",15,45)}else t.fillStyle="#000",t.fillRect(0,0,this.width,this.height),t.fillStyle="#0f0",t.font="20px monospace",t.textAlign="center",t.fillText("WebGL not available",this.width/2,this.height/2)}stop(){super.stop(),this._glRenderer&&this._glRenderer.destroy()}}function v(r){const t=new d(r);return t.start(),{stop:()=>t.stop(),game:t}}export{v as default};
